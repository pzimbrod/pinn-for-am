...
files = glob.glob("*_epochen_bash.csv")
i = len(files)
...
ergebnis = open(str(i) + '_epochen_bash.csv', 'w')
...
auswertung = (test_train_distribution, test_num_domain, test_num_boundary, test_num_initial, test_activation, test_nn_layers, time_taken, model.losshistory.steps[-1], steps_adam, steps_LBFSG,  loss_0, loss_1)
