...
files = glob.glob("*_vorversuch_bash.csv")
i = len(files)
t = 0 
j = 0
n = 0 
...
#CSV
header = ('train distribution', 'domain', 'boundary', 'initial', 'activation', 'layers', 'time taken', 'steps', 'steps_adam', 'steps_L-BFSG', 'loss 0', 'loss 1', 'code')
ergebnis = open(str(i) + '_vorversuch_bash.csv', 'w')
...
auswertung = (test_train_distribution[t], test_num_domain[j], test_num_boundary[n], test_num_initial[h], test_activation[a], test_nn_layers[l], time_taken, model.losshistory.steps[-1], steps_adam, steps_LBFSG,  loss_0, loss_1, (t, j, n, h, l, a))
